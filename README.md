...
- 二维码在原布局位置基础上下移 12px，尺寸缩小为原尺寸的 90%，并增加 0.5px 宽的联想红正方形边框；下方“联想官方体验店”和“请您添加企业微信”两行文字通过同一定位容器与二维码关联，文字上缘距下移后的二维码底部精确为 10px；文字块字号为 1.8mm，并限制在 5.4mm 高的隐藏溢出安全区内，确保不会越过背景底框；
